...
begin
  ...
  begin
    ...
    if oDispositivo.Count > 0 then
      Result.AddPair('dispositivo', oDispositivo)
    else
      oDispositivo.Free;
  end;
  ...
  begin
    ...
    try
      ...
      oDispositivo.AddPair('ativo', True);
...
begin
  ...
  begin
    ...
    {TODO: Aqui deve enviar para API do MediaMTX o id do usuário ou algo do tipo e adicionar na chamada}
  end;
...
begin
  ...
  {TODO: Aqui deve enviar para API do MediaMTX o id do usuário ou algo do tipo para remover da chamada}
end;
